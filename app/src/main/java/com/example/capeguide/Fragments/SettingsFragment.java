...
import com.example.capeguide.databinding.FragmentSettingsBinding;
...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.cardEmail.setOnClickListener(view -> {
            SettingsFragmentDirections.ActionBtnSettingToEmailConfirmationFragment2 directions =
                    SettingsFragmentDirections.actionBtnSettingToEmailConfirmationFragment2();
            ...
            firebaseAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(getContext(), "Email has been sent, please verify the email", Toast.LENGTH_SHORT).show();
                    } else {
