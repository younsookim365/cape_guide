...
package com.example.capeguide.Fragments;
...
import com.example.capeguide.Adapter.GooglePlaceAdapter;
import com.example.capeguide.Adapter.InfoWindowAdapter;
...
import com.example.capeguide.NearLocationInterface;
...
import com.example.capeguide.SavedPlaceModel;
...
import com.example.capeguide.databinding.FragmentHomeBinding;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (appPermissions.isLocationOk(requireContext())) {
            ...
            new AlertDialog.Builder(requireContext())
                    ...
                    .setMessage("Cape Guide requires location permission to show you nearby places")
