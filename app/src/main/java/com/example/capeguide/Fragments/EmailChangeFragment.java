...
public class EmailChangeFragment extends Fragment {
    ...
    private com.example.capeguide.databinding.FragmentEmailChangeBinding binding;
    private LoadingDialog loadingDialog;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = com.example.capeguide.databinding.FragmentEmailChangeBinding.inflate(inflater, container, false);
