...
import com.example.capeguide.databinding.FragmentEmailConfirmationBinding;
                ...
                firebaseAuth.getCurrentUser().reauthenticate(authCredential).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (isPassword) {
                                Navigation.findNavController(view).navigate(R.id.action_emailConfirmationFragment_to_passwordChangeFragment2);
                            } else {
